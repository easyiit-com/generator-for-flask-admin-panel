...
class Api%%model_class_name%%List(Resource):
    ...
    def get(self):
        ...
        return {"msg": "Get Successfully", "data": %%model_name%%_dicts}, 200
...
class Api%%model_class_name%%Create(Resource):
    ...
    def put(self, %%model_name%%_id=None):
        ...
        db_session.commit()
        return {"msg": "Created successfully", "data": new_%%model_name%%.to_dict()}, 201
...
class Api%%model_class_name%%(Resource):
    ...
    def get(self, %%model_name%%_id):
        ...
        return {"msg": "Get Successfully", "data": %%model_name%%.to_dict()}, 200
